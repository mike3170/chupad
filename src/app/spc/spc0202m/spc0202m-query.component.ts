...
@Component({
  selector: 'spc0202m-query',
  templateUrl: "./spc0202m-query.component.html",
  styleUrls: ["./spc0202m-query.component.scss"],
  providers: [ Spc0202mService ]
})
export class Spc0202mQueryComponent extends DialogUtil implements OnInit {
  formQry: FormGroup;

  constructor(
    private spc0202mSvc: Spc0202mService,
    private fb: FormBuilder,
    private dialogRef: MatDialogRef<Spc0202mQueryComponent>,
    injector: Injector) { 
      super(injector);
    }
